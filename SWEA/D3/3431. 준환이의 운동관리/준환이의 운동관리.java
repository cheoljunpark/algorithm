...
/*
 * 1. 테스트 케이스를 입력받는다
 * 2. 각 테스트 케이스별로 최소운동시간(minExerciseTime), 최대운동시간(maxExerciseTime), 운동한시간(exerciseTime)을 입력받는다
...
public class Solution {
     ...
     * 운동 결과를 반환하는 메소드
     *
     * @return 필요한 양보다 더 많은 운동을 하고 있다면 -1, 적절하게 하고 있다면 0, 아니라면 추가로 운동해야 하는 시간
     */
